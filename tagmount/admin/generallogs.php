...
if (isset($_POST['arama'])) {
  ...
  left join users u on u.ID=vt.USER_ID WHERE v.ACTIVE=1  and u.COMPANY_ID=:ID GROUP BY v.VIDEO_NAME ");
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="text-center"><a href="shows.php?ID=<?php echo $icerikcek['ID']; ?>"><?php echo $icerikcek['VIDEO_NAME']; ?></td><?php ?>
