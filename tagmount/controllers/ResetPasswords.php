...
class ResetPasswords{
    ...
    public function __construct(){
        ...
        $this->mail->Port = 587;
        $this->mail->Username = 'tagmount2022@gmail.com';
        $this->mail->Password = '2022.tag.mount';
    }
    ...
    public function sendEmail(){
        ...
        if(empty($usersEmail)){
            ...
            redirect("login/resetpassword.php");
        }
        ...
        $url = 'https://tagmount.info/login/newpassword.php?selector='.$selector.'&validator='.bin2hex($token);
        ...
        $this->mail->setFrom('tagmount2022@gmail.com','Tagmount');
    ...
    public function resetPassword(){
        ...
        $url = '../login/newpassword.php?selector='.$data['selector'].'&validator='.$data['validator'];
